			...
			<div class="container">
				<div class="signup-content">
					...
					<div class="signup-image">
						<figure>
							<img src="images/reglogo.jpeg" alt="sing up image">
						</figure>
...
<script type="text/javascript">
	...
	if(status == "invalidEmailStudent"){
		swal("Sorry","Please Enter Valid Email Student","error");
	}
	if(status == "invalidMatric"){
		swal("Sorry","Please Enter Valid Matric Number","error");
	}
