...
//    }
	...
	public static void insertUser(Parcel parcel) throws SQLException {
//		Connection con = null;
...
//		Connection con = null;
	...
	public static List<Parcel> selectAllUsers() {
...
//		Connection con = null;
	...
	public static boolean updateUser(Parcel parcel) throws SQLException {
...
//		Connection con = null;
	...
	public static List<Parcel> selectAvailable() {
...
//		Connection con = null;
	...
	public static List<Parcel> selectAllsearch(String searchTerm) {
...
//		Connection con = null;
	...
	public static List<Parcel> selectAvailablesearch(String searchTerm) {
		List<Parcel> parcels = new ArrayList<>();
//		Connection con = null;
		try {
			con = GetConnection.getConnection();	
	...
	public static int getCountOfDateIn(String dateIn) {
...
//		Connection con = null;
	...
	public static int getAllCountOfDateIn(String dateIn) {
		int count = 0;
//		Connection con = null;
		try {
			con = GetConnection.getConnection();	
