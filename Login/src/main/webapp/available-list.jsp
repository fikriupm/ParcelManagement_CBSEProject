...
<body>
    ...
    <ul class="navbar-nav mr-auto">
        ...
        </li> <!-- Added button for Parcel Report -->
    </ul>
	...
	<div class="row">
    <div class="container">
        <h3 class="text-center">List of Available Parcel</h3>
        <hr>
                    ...
                    <div class="form-group">
                        <form action="searchAvailable" method="get">
                            <div class="input-group">
                                <input type="text" name="searchTerm" placeholder="Search by Date or Name" class="form-control">
